...
<div className={classes.cards}>
    ...
    {/* <div data-aos="fade-up" className={classes.card}>
                ...
                <div data-aos="fade-up" className={classes.card}>
                        ...
                        <div className={classes.column__content}> 
                        <Link href='https://instagram.com/viol.tech?utm_medium=copy_link'>
                            <a target="_blank" className={classes.Link}>
                                <h6>Instagram</h6>
                            </a>
                        </Link>
                        <Link href='https://www.facebook.com/thevioltech/'>
                            <a target="_blank" className={classes.Link}>
                                <h6>Facebook</h6>
                            </a>
                        </Link>
                        <Link href='https://www.linkedin.com/company/violtech/'>
                            <a target="_blank" className={classes.Link}>
                                <h6>LinkedIn</h6>
                            </a>
                        </Link>                          
